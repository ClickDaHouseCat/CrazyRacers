...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const winnerName = document.getElementById('winner-name');
      const winnerImage = document.getElementById('winner-image');
      const betForm = document.getElementById('bet-form'); // Добавлено: форма для ставок
      const userBalanceDisplay = document.getElementById('user-balance'); // Добавлено: отображение баланса пользователя

      let userBalance = 10000;
      userBalanceDisplay.textContent = userBalance; // Отображаем начальный баланс пользователя
